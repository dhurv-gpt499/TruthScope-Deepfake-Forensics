...
if __name__ == "__main__":
    import uvicorn
    # run with (Mac/Linux): PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True ./.venv_main/bin/python run_web.py
    # run with (Windows): $env:PYTORCH_CUDA_ALLOC_CONF="expandable_segments:True"; .\.venv_main\Scripts\python run_web.py
    uvicorn.run(
        "run_web:app", 
        host="0.0.0.0", 
        port=8000, 
