...
# $env:PYTORCH_CUDA_ALLOC_CONF="expandable_segments:True"; .\.venv_main\Scripts\python run_web.py
...
# Windows:
# $env:PYTORCH_CUDA_ALLOC_CONF="expandable_segments:True"; .\.venv_main\Scripts\python verify_tools.py --image path/to/face.jpg
...
# Windows:
# $env:PYTORCH_CUDA_ALLOC_CONF="expandable_segments:True"; .\.venv_main\Scripts\python verify_tools.py
```
